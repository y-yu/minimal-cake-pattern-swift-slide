...
\section{Dependency Injectionとそのメリット}
...
\begin{frame}
  ...
  \begin{center}
    ...
    \uncover<6->{
      \begin{tikzpicture}
        \calloutquote[width=6cm,position={(-0.7,-0.2)},fill=red!30,rounded corners]{Cake Patternの仲間を紹介！}
      \end{tikzpicture}
    }
  \end{center}
\end{frame}
...
\begin{frame}
  ...
  \begin{center}
    \uncover<6->{
      \begin{tikzpicture}
        \calloutquote[width=5cm,position={(0.7,-0.2)},fill=green!30,rounded corners]{機能ごとに考えていこう！}
      \end{tikzpicture}
    }
  \end{center}
\end{frame}
...
\begin{frame}
  ...
  \begin{center}
    \uncover<2->{
      \begin{tikzpicture}
        \calloutquote[width=12cm,position={(-0.7,-0.2)},fill=blue!30,rounded corners]{設定ファイルのパスを受け取って、ファイルをオープンしてソルトを読み込む}
      \end{tikzpicture}
    }
  \end{center}
\end{frame}
...
\begin{frame}
  ...
  \begin{center}
    \uncover<2->{
      \begin{tikzpicture}
        \calloutquote[width=11cm,position={(-0.7,-0.2)},fill=green!30,rounded corners]{設定ファイルのパスはダミー、ソルトも引数で与えられたダミー値を必ず返す}
      \end{tikzpicture}
    }
  \end{center}
\end{frame}
  ...
  \begin{enumerate}
    \item<2-> インターフェースを作成
      ...
      \begin{center}
        \uncover<3->{
          \begin{tikzpicture}
            \calloutquote[width=10cm,position={(-0.7,-0.2)},fill=green!30,rounded corners]{\texttt{ReadConfigService}のインターフェースを入れる}
          \end{tikzpicture}
        }
      \end{center}
  ...
  \begin{enumerate}
    \item<1-> メイン実装を作成
      ...
      \begin{center}
        \uncover<2->{
          \begin{tikzpicture}
            \calloutquote[width=8cm,position={(0.7,-0.2)},fill=green!30,rounded corners]{\texttt{ReadConfigService}はメインの実装をDI}
          \end{tikzpicture}
        }
      \end{center}
    ...
    \item<3-> テスト実装を作成
      ...
      \begin{center}
        \uncover<4->{
          \begin{tikzpicture}
            \calloutquote[width=7cm,position={(-0.7,-0.2)},fill=cyan!30,rounded corners]{\texttt{ReadConfigService}はモックをDI}
          \end{tikzpicture}
        }
      \end{center}
  \end{enumerate}
